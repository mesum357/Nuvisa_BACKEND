...
export default {
  ...
  ALLOW_ORIGIN_NOAUTH: process.env.ALLOW_ORIGIN_NOAUTH || "http://localhost:3001,http://localhost:3000,https://nuvisa-admin-updated.vercel.app,https://nuvisa-admin.vercel.app",
};
